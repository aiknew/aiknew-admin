...
export class ArticleCategoryController {
  ...
  @Get("all")
  @Permission({
    key: "article-category:getAll",
    name: "article-category.articleCategoryGetAll",
  })
  @AppApiOkResponse([ArticleCategoryDto])
  async getAll(
    @Query() query: QueryArticleCategoryDto,
  ...
  @Post()
  @Permission({
    key: "article-category:create",
    name: "article-category.articleCategoryCreate",
  })
  @AppApiCreatedResponse()
  ...
  @Patch(":id")
  @Permission({
    key: "article-category:update",
    name: "article-category.articleCategoryUpdate",
  })
  @AppApiOkResponse()
  async updateOne(
    @Param("id") id: string,
  ...
  @Delete(":id")
  @Permission({
    key: "article-category:delete",
    name: "article-category.articleCategoryDelete",
  })
  @AppApiOkResponse()
