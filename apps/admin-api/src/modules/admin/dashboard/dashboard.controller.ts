...
import { AppApiOkResponse, Permission, PermissionGroup, Public } from '@aiknew/shared-api-decorators';
...
export class DashboardController {
  ...
  @Public()
  @Permission({ key: 'dashboard:home-statistics', name: 'dashboard.homeStatistics' })
  @Get('home-statistics')
