...
export class FileStorageController {
  ...
  @Permission({
    key: "file-storage:pagination",
    name: "file-storage.fileStoragePagination",
  })
  @Get()
  ...
  @Permission({
    key: "file-storage:getAll",
    name: "file-storage.fileStorageGetAll",
  })
  @Get("all")
  ...
  @Permission({
    key: "file-storage:create",
    name: "file-storage.fileStorageCreate",
  })
  @Post()
  @AppApiCreatedResponse()
  ...
  @Permission({
    key: "file-storage:update",
    name: "file-storage.fileStorageUpdate",
  })
  @Patch(":id")
  @AppApiOkResponse()
  ...
  @Permission({
    key: "file-storage:delete",
    name: "file-storage.fileStorageDelete",
  })
  @Delete(":id")
  @AppApiOkResponse()
