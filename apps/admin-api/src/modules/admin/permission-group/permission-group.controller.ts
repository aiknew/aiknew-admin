...
export class PermissionGroupController {
  ...
  @Get()
  @Permission({
    key: "permissionGroup:pagination",
    name: "permission-group.permissionGroupPagination",
  })
  ...
  @Get("all")
  @Permission({
    key: "permissionGroup:getAll",
    name: "permission-group.permissionGroupGetAll",
  })
  @AppApiOkResponse([PermissionGroupDto])
  async getAll(): Promise<PermissionGroupDto[]> {
    return await this.service.getAll()
  }

  @Post()
  @Permission({
    key: "permissionGroup:create",
    name: "permission-group.permissionGroupCreate",
  })
  @AppApiCreatedResponse()
  ...
  @Patch(":id")
  @Permission({
    key: "permissionGroup:update",
    name: "permission-group.permissionGroupUpdate",
  })
  @AppApiOkResponse()
  async updateOne(
    @Param("id") id: string,
  ...
  @Delete(":id")
  @Permission({
    key: "permissionGroup:delete",
    name: "permission-group.permissionGroupDelete",
  })
  @AppApiOkResponse()
