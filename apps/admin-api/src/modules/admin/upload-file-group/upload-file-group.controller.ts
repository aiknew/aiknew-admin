...
export class UploadFileGroupController {
   ...
   */
  @Permission({
    key: "upload-file-group:findChildren",
    name: "upload-file-group.uploadFileGroupFindChildren",
  })
  @Get(":id")
  ...
  @Permission({
    key: "upload-file-group:create",
    name: "upload-file-group.uploadFileGroupCreate",
  })
  ...
  @Permission({
    key: "upload-file-group:update",
    name: "upload-file-group.uploadFileGroupUpdate",
  })
  ...
  @Permission({
    key: "upload-file-group:delete",
    name: "upload-file-group.uploadFileGroupDelete",
  })
