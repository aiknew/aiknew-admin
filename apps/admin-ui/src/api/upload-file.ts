...
export type UploadFilesAndGroupsDto =
  ApiGetData<"/admin/upload-file/filesAndGroups">

export type UploadFilesAndGroupsQuery =
  ApiGetQuery<"/admin/upload-file/filesAndGroups">
...
export const useUploadFilesAndGroups = (
  query: Ref<UploadFilesAndGroupsQuery | undefined>,
) => {
  return useQuery({
...
export const useUploadFilePresigned = (
  query: Ref<UploadFilePresignedQuery | undefined>,
) => {
  return useQuery({
