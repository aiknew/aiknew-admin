...
<template>
  <aside
    class="linear fixed top-0 left-0 z-10 inline-flex h-full min-h-screen shrink-0 origin-center overflow-hidden border-r border-gray-100 bg-white px-4 transition md:relative"
