...
export { default as AppLanguageSwitcher } from './language-switcher/app-language-switcher.vue'
export { default as AppRouteTab } from './app-route-tab.vue'
export { default as AppDarkModeSwitcher } from './app-dark-mode-switcher.vue'
export { default as AppEditor } from './app-editor.vue'
