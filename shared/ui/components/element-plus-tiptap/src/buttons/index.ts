...
export const BUTTON_MAP = {
  'align-center': defineAsyncComponent(() => import('./align-center-button.vue')),
  'align-justify': defineAsyncComponent(() => import('./align-justify-button.vue')),
  ...
  'horizontal-rule': defineAsyncComponent(() => import('./horizontal-rule-button.vue')),
  'italic': defineAsyncComponent(() => import('./italic-button.vue')),
  'link': defineAsyncComponent(() => import('./link-button.vue')),
  'ordered-list': defineAsyncComponent(() => import('./ordered-list-button.vue')),
